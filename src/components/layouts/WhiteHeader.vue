<template>
    <div class="left-container">
        <img class="header-img" :src="logo.src_white" alt="">
        <el-menu
                ...
                @select="handleSelect"
                text-color="#fff"
                active-text-color="#ffd04b" style="background: none;!important;">
    ...
    export default {
        ...
        data() {
            return {
                ...
                activeIndex2: this.$store.state.activeIndex
